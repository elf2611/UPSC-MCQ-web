...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[90vh] flex flex-col items-center justify-center p-4 relative">
      ...
      <div className="w-full max-w-md bg-card shadow-surface rounded-2xl p-8 sm:p-10 z-10 relative">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-display font-bold text-foreground tracking-tight mb-2">Welcome Back</h1>
          <p className="text-muted-foreground">Sign in to continue your UPSC preparation.</p>
        </div>
        ...
        <form onSubmit={handleEmailLogin} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-primary text-primary-foreground font-bold py-3.5 rounded-lg shadow-[0_0_20px_rgba(255,191,0,0.2)] hover:scale-[0.98] active:scale-95 ease-snappy transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
