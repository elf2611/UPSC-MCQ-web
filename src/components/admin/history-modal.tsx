                ...
                <div key={h.id} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                  ...
                  <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white/5 p-4 rounded-lg border border-white/10">
                    <div className="flex justify-between items-start mb-1">
                      <span className="text-xs text-gray-400 font-mono">{new Date(h.edited_at).toLocaleString()}</span>
                      <button 
                    ...
                    <p className="text-sm text-gray-300">Edited by {h.profiles?.email || 'Unknown Admin'}</p>
